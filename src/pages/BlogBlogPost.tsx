  ...
  return (
    <>
      ...
      <div style={{ padding: '8rem 5% 5rem', minHeight: '100vh', maxWidth: '800px', margin: '0 auto' }}>
        <Link to="/blog" style={{ color: '#d4af37', textDecoration: 'none', marginBottom: '2rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontWeight: 500, transition: 'all 0.3s ease' }}>
          &larr; Back to Blog
        </Link>
